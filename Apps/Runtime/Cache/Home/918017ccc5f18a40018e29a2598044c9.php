...
<!--            <li>
	    ...
	    <li>
		<a href="<?php echo U('Ord/index');?>"><i class="fa fa-envelope nav_icon"></i>订单<span class="fa arrow"></span></a>
		<ul class="nav nav-second-level">
		    <li><a href="<?php echo U('Ord/index');?>" style="font:2px">订单列表</a></li>
		</ul>
		<!-- /.nav-second-level -->
	    </li>
...
//                    alert('提醒');
                ...
                case '2':
//                        alert('签收');
                    var url = "<?php echo U('Ord/qianshou');?>";
                    url += '?orderid=' + orderid;
                    console.log(url);
                    window.location.href = url;
                    break;
                case '3':
                    //  alert('评价');
                    var url = "<?php echo U('Ord/comment');?>";
                    url += '?orderid=' + orderid;
                    console.log(url);
                    window.location.href = url;
                    break;
