...
<table class="table">
	<caption style="font-size:38px">栏目添加</caption>
	<thead>
	    <tr>
		<th>字段</th>
		<th>值</th>
	...
	<tbody>
        <form action='<?php echo U($do_add_url);?>' method='POST'>
            <?php if(is_array($info)): foreach($info as $key=>$value): ?><tr>
                    <td><?php echo ($key); ?></td>
                    <td><input type='text' name="<?php echo ($key); ?>" placeholder='<?php echo ($value); ?>'></input></td>
