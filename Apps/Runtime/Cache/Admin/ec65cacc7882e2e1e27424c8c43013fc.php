...
<div class="navbar-default sidebar col-sm-3 col-md-2" role="navigation">
            ...
            <table class="table" >
                    <caption style="font-size:38px">栏目列表</caption>
                    <thead>
                        <tr>
                            <th>栏目id</th>
                            <th>栏目名称</th>
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$info): ?><tr>
                            <td><?php echo ($info[channelid]); ?></td>
                            <td><?php echo ($info[channelname]); ?></td>
                            <td><?php echo ($info[status]); ?></td>
                            <td><a href="<?php echo U($list_info_url,'channelid='.$info[channelid]);?>">详情</a></td>
                            <td><a href="<?php echo U($list_add_url,'channelid='.$info[channelid]);?>">添加</a></td>
                            <td><a href="<?php echo U($list_modify_url,'channelid='.$info[channelid]);?>">修改</a></td>
